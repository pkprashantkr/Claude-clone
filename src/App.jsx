  ...
  return (
    ...
    <div className="bg-[#FAFAF8] h-full w-full">
      <nav className="w-full h-5 my-0 p-4 ml-2 px-10 flex justify-between">
        ...
        <div className='px-20'>
            <div className='max-w-4xl mx-20 my-12 px-6  rounded-3xl flex items-center justify-between  bg-[#F0EFEA]' >
            ...
            <div className='max-w-4xl ml-62 px-10  rounded-3xl flex items-center justify-between  bg-[#F0EFEA]' >
                <div className='px-4 py-10 flex flex-col text-left'>
